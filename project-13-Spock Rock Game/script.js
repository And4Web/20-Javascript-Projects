...
function resetSelected(){
  allGamesIcons.forEach((icon, ind)=>{
...
// Reset Score and playerChoice and computerChoice
function resetAll(){
  playerScoreNumber = 0;
...
// Check result, increase score, update the result text
function updateScore(playerChoice){
  ...
  if(playerChoice === computerChoice){
    ...
    if(choice.defeats.indexOf(computerChoice) > -1){
      // startConfetti()
      // dynamic import: only load confetti.js when needed - performance optimization.
